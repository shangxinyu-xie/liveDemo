      ...
      return {
        playerOptions: {
          ...
          sources: [{
            ...
            //type: "video/mp4",
            type:"rtmp/flv",
            src: "rtmp://www.argen3630.cn/hls/test"
            //src:"http://www.argen3630.cn/hello.mp4"
          }],
          autoPlay: true,
          controlBar: {
            timeDivider: false,
    ...
    methods: {
      changehls(){
        ...
        $dialog.alert({
          effect: 'default',
          title: '提示',
          content: '请使用推流软件推送到rtmp://www.argen3630.cn/hls/test,即可在本直播间看到您的直播内容,具体操作请看demo说明',
          okText: '确定',
          okTheme: 'assertive'
        })
        this.player.pause()
        this.player.src("http://www.argen3630.cn/hls/test")
        this.player.play()
      },
      open: function () {
